...
> This document generally applies to the Dokku core project, and may be overriden by individual sub-projects. Please consult the `README.md` and `CONTRIBUTING.md` files for those projects as necessary.
...
* Fund the Dokku project via [OpenCollective](https://opencollective.com/dokku#support) or [Patreon](https://www.patreon.com/dokku)
* [Sponsor new functionality](/SPONSORING.md)
